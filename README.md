...
| double-click on a row | the same as `enter` on it: open the PR, focus the worker, expand or collapse the group, view the report. Two clicks on one row within 400 ms count |
